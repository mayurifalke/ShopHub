      ...
      <div>
        <header style={{ height: "auto" }}>
          ...
          <nav className={`nav_bar ${style.nav}`}>
           <Link to="/">Home</Link>
           <Link to="/homeitems">Men</Link>
           <Link to="/homeitems">Women</Link>
           <Link to="/homeitems">Brands</Link>
           <Link to="/homeitems">Collections<sup>New</sup></Link>
          </nav>
          <div className={`search_bar${style.searchbar}`}>
            ...
            <input
              ...
              placeholder="Search for Perfumes, brands and more"
            />
          </div>
